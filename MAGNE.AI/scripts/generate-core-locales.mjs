...
const copy = {
  en: {
    ...
    footer: { product: "Product", verify: "Verification", connect: "Connect", resources: "Resources", follow: "Follow", preorder: "Pre-order", contact: "Contact", privacy: "Privacy Policy", whitepaper: "Whitepaper ↗" },
    phone: {
  ...
  ja: {
    ...
    nav: { phone: "PHONE", ai: "AI", network: "NETWORK", security: "SECURITY", compliance: "COMPLIANCE", progress: "PROGRESS", partners: "PARTNERS", media: "MEDIA KIT", contact: "CONTACT" },
    footer: { product: "製品", verify: "検証", connect: "リンク", resources: "資料", follow: "公式アカウント", preorder: "予約", contact: "お問い合わせ", privacy: "プライバシーポリシー", whitepaper: "ホワイトペーパー ↗" },
    phone: {
  ...
  ko: {
    ...
    nav: { phone: "PHONE", ai: "AI", network: "NETWORK", security: "SECURITY", compliance: "COMPLIANCE", progress: "PROGRESS", partners: "PARTNERS", media: "MEDIA KIT", contact: "CONTACT" },
    footer: { product: "제품", verify: "검증", connect: "연결", resources: "자료", follow: "공식 채널", preorder: "사전 주문", contact: "문의", privacy: "개인정보 처리방침", whitepaper: "백서 ↗" },
    phone: {
